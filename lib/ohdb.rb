...
require 'lib/ohdb/models/license'
require 'lib/ohdb/models/platform'

require 'lib/ohdb/tasks/task_class_methods'
require 'lib/ohdb/tasks/task'
require 'lib/ohdb/tasks/monthly_task'
...
require 'lib/ohdb/tasks/platform_task'
require 'lib/ohdb/tasks/license_task'
...
require 'lib/ohdb/commands/size'
